...
Singleton {
    ...
    sizes: QtObject {
        ...
        property real barCenterSideModuleWidth: Config.options?.bar.verbose ? 200 : 140
        property real barCenterSideModuleWidthShortened: 130
        property real barCenterSideModuleWidthHellaShortened: 30
